...
<div align="center">
  <img src="assets/cards/header.svg" width="100%" alt="Hi, I'm Ayush!" />
</div>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="24%" align="center"><img src="assets/cards/info_1.svg" width="100%" /></td>
    <td width="1.3%">&nbsp;</td>
    <td width="24%" align="center"><img src="assets/cards/info_2.svg" width="100%" /></td>
    <td width="1.3%">&nbsp;</td>
    <td width="24%" align="center"><img src="assets/cards/info_3.svg" width="100%" /></td>
    <td width="1.3%">&nbsp;</td>
    <td width="24%" align="center"><img src="assets/cards/info_4.svg" width="100%" /></td>
  </tr>
</table>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="37%" valign="top">
      <img src="assets/cards/about_me.svg" width="100%" />
      
      <!-- Clickable Action Buttons -->
      <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px; margin-bottom: 15px;">
        <tr>
          <td width="48%" align="center">
            <a href="mailto:{profile["about_me"]["email"]}">
              <img src="assets/cards/btn_email.svg" width="100%" alt="Email Me" />
            </a>
          </td>
          <td width="4%">&nbsp;</td>
          <td width="48%" align="center">
            <a href="{profile["about_me"]["resume_url"]}">
              <img src="assets/cards/btn_resume.svg" width="100%" alt="Resume" />
            </a>
          </td>
        </tr>
      </table>
      
      <img src="assets/cards/tech_stack.svg" width="100%" style="margin-bottom: 15px;" /><br/>
      <img src="assets/cards/principles.svg" width="100%" style="margin-bottom: 15px;" /><br/>
      <img src="assets/cards/currently_building.svg" width="100%" />
    </td>
    ...
    <td width="60%" valign="top">
      <img src="assets/cards/what_i_build.svg" width="100%" style="margin-bottom: 15px;" /><br/>
      
      <!-- Featured Projects (Fully Clickable) -->
      <h3 style="font-family: 'Outfit', sans-serif; color: #2c1e1e; font-size: 15px; font-weight: 700; margin-top: 0; margin-bottom: 10px;">🚀 Featured Projects</h3>
      {"".join([f'''<a href="{project["url"]}"><img src="assets/cards/project_{idx}.svg" width="100%" style="margin-bottom: 10px;" alt="{project["name"]}" /></a><br/>''' for idx, project in enumerate(profile["featured_projects"])])}
      <div align="right" style="margin-top: 4px; margin-bottom: 20px;">
      ...
      <h3 style="font-family: 'Outfit', sans-serif; color: #2c1e1e; font-size: 15px; font-weight: 700; margin-top: 0; margin-bottom: 10px;">📊 GitHub Analytics</h3>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-bottom: 15px;">
        <tr>
          <td width="49%" valign="top">
            <a href="{profile["about_me"]["github_url"]}">
              <img src="https://github-readme-stats.vercel.app/api?username={profile["about_me"]["github_url"].split('/')[-1]}&amp;show_icons=true&amp;theme=default&amp;bg_color=fffdfa&amp;border_color=e5dacf&amp;title_color=2c1e1e&amp;text_color=3c2f2f&amp;icon_color=b05a30&amp;border_radius=8" width="100%" alt="GitHub Stats" />
            </a>
          </td>
          <td width="2%">&nbsp;</td>
          <td width="49%" valign="top">
            <a href="{profile["about_me"]["github_url"]}">
              <img src="https://github-readme-stats.vercel.app/api/top-langs/?username={profile["about_me"]["github_url"].split('/')[-1]}&amp;layout=compact&amp;theme=default&amp;bg_color=fffdfa&amp;border_color=e5dacf&amp;title_color=2c1e1e&amp;text_color=3c2f2f&amp;icon_color=b05a30&amp;border_radius=8" width="100%" alt="Top Languages" />
            </a>
          </td>
        </tr>
        <tr>
          <td colspan="3" style="padding-top: 10px;">
            <a href="{profile["about_me"]["github_url"]}">
              <img src="https://streak-stats.demolab.com?user={profile["about_me"]["github_url"].split('/')[-1]}&amp;theme=default&amp;background=fffdfa&amp;border=e5dacf&amp;stroke=b05a30&amp;ring=b05a30&amp;fire=b05a30&amp;currStreakNum=2c1e1e&amp;sideNums=3c2f2f&amp;sideLabels=7a6a65&amp;dates=9c8b86&amp;border_radius=8" width="100%" alt="Streak Stats" />
            </a>
          </td>
        </tr>
        <!-- Yoshi389111 3D Contribution Graph integration -->
        <tr>
          <td colspan="3" style="padding-top: 10px;" align="center">
            <img src="./profile-3d-contrib/profile-south-season-animate.svg" width="80%" alt="3D Contributions Graph" />
          </td>
        </tr>
      </table>
      
      <img src="assets/cards/upcoming_projects.svg" width="100%" style="margin-bottom: 15px;" /><br/>
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
        <tr>
          <td width="30%">
            <a href="{profile["about_me"]["github_url"]}">
              <img src="assets/cards/icon_github.svg" width="100%" alt="GitHub" />
            </a>
          </td>
          <td width="5%">&nbsp;</td>
          <td width="30%">
            <a href="{profile["about_me"]["linkedin_url"]}">
              <img src="assets/cards/icon_linkedin.svg" width="100%" alt="LinkedIn" />
            </a>
          </td>
          <td width="5%">&nbsp;</td>
          <td width="30%">
            <a href="mailto:{profile["about_me"]["email"]}">
              <img src="assets/cards/icon_email.svg" width="100%" alt="Email" />
            </a>
          </td>
        </tr>
      </table>
...
<div align="center">
  <img src="assets/cards/footer.svg" width="100%" alt="Footer Banner" />
</div>
"""
